...
- Clarity over decoration; one job per view/section when advising UI
- Respect existing design system if the repo has one
- Prefer concrete flow + copy; avoid generic purple/dashboard filler advice
